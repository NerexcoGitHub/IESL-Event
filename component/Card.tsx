...
const TicketCard: React.FC<any> = (props:any) => {
    ...
    >
      <div className="p-2 sm:p-2 md:py-2 md:px-2 lg:p-2 xl:py-2 xl:px-2 2xl:p-2">
        <div className="sm:flex justify-around align-middle">
          <div className="justify-around align-middle w-full h-full flex-[0.5] flex">
            <p className=" text-xl mt-1 font-medium text-body-color sm:mt-4 ">
              Table No :
            </p>
            <h3 className="block text-left text-4xl font-bold text-black hover:text-primary dark:text-white dark:hover:text-primary sm:text-6xl">
            {table_no}
            </h3>
          </div>
